...
\begin{figure}[ht!]
	...
	\caption{Step response plot for open loop csim block}
	\label{overflow}
\end{figure}
...
\begin{thebibliography}{99}
	...
	\bibitem{c9} Dictino Chaos, Jesus Chacon, Jose Antonio Lopez-Orozco and Sebastian Dormido : Virtual and Remote Robotic Laboratory Using EJS, MATLAB and LabVIEW
	...
	\bibitem{c11} Scilab, open source software for numerical computation, http://www.scilab.org
